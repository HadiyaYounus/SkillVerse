      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-10">
          ...
          <button
            ...
            className="bg-[#2f2f2f] border border-[#40414f] rounded-xl px-6 py-3"
          >
            Clear
          </button>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            {filteredSkills.map((skill) => (
              ...
              >
                ...
                <Link
                  to={`/skills/${skill.id}`}
                  className="block mt-6 text-center bg-white text-black py-3 rounded-xl font-semibold"
                >
                  View Details
                </Link>
